...
$query_role="INSERT INTO user_role_bridge (user_id,on_update) VALUES ('".$userid."','".date('Y-m-d h:i:sa')."' ) ";
$execution_role = mysqli_query($connection,$query_role); 


 	header("location: add_new_user.php?message=Registration Completed Successfully");

}
else
		{
			header("location: add_new_user.php?message=Registration Fail Please Try Again ");
		}
	}
	else
	{
	header("location:  add_new_user.php?message=Please Register Your Account");
	}
?>